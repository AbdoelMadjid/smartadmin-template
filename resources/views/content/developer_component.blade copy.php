    ...
    <x-row-column :column="2">
        ...
        <x-slot name="column2">
            <x-panel.show title="Component" subtitle="Div or Span">
                ...
                <br>
                HTML : <code>&lt;span class="h5"&gt;Pro Tip!&lt;/span&gt;</code> <br>Output : <x-div :text="__('Pro Tip!')" class="h5" />
                <hr>
                ...
                <br>
                HTML : <code>&lt;div class="h5"&gt;Pro Tip!&lt;/div&gt;</code> <br>Output : <x-div div :text="__('Pro Tip!')" class="h5" />
                <hr>
            </x-panel.show>
                        ...
                        <x-row-column :column="2">
                            <x-slot name="column1">
                                <code>&lt;x-button
                                    ...
                                    effect /&gt;</code>
                                <hr>
                                <x-button href="javascript:void(0);" color="primary" size="lg" icon="users" btnicon circle effect />
                                <x-button href="javascript:void(0);" color="success" size="lg" icon="save" btnicon circle effect />
                                <x-button href="javascript:void(0);" color="secondary" size="lg" icon="home" btnicon circle effect />
                                <x-button href="javascript:void(0);" color="danger" size="lg" icon="trash" btnicon circle effect />
                            </x-slot>
                            <x-slot name="column2">
                            </x-slot>
                        </x-row-column>
                    ...
                    <div class="tab-pane fade" id="tab8" role="tabpanel">
                        ...
                        <x-row-column :column="4">
                            <x-slot name="column1">
                                ...
                                <div class="btn-group">
                                    <x-button color="primary" icon="print" :label="__('Print')" dropdowntoggle toggle="dropdown" haspopup="true" expanded="false" :items="[
                            ...
                            <x-slot name="column2">
                                ...
                                <div class="btn-group dropleft">
                                    <x-button color="danger" :label="__('Pilihan')" dropdowntoggle toggle="dropdown" haspopup="true" expanded="false" :items="[
                                                ['label' => 'Action', 'href' => 'javascript:void(0);'],
                                                ['label' => 'Another action', 'href' => 'javascript:void(0);'],
                                                ['label' => 'Something else here', 'href' => 'javascript:void(0);'],
                                                'divider',
                            ...
                            <x-slot name="column3">
                                ...
                                <div class="btn-group dropright">
                                    <x-button color="warning" :label="__('Pilihan')" dropdowntoggle toggle="dropdown" haspopup="true" expanded="false" :items="[
                                                ['label' => 'Action', 'href' => 'javascript:void(0);'],
                                                ['label' => 'Another action', 'href' => 'javascript:void(0);'],
                                                ['label' => 'Something else here', 'href' => 'javascript:void(0);'],
                                                'divider',
                            ...
                            <x-slot name="column4">
                                ...
                                <hr>
                                <div class="btn-group">
                                    <x-button color="secondary" :label="__('Pilihan')" dropdowntoggle toggle="dropdown" haspopup="true" expanded="false" display="static" :items="[
                                                ['label' => 'Action', 'href' => 'javascript:void(0);'],
                                                ['label' => 'Another action', 'href' => 'javascript:void(0);'],
                                                ['label' => 'Something else here', 'href' => 'javascript:void(0);'],
                                                'divider',
                        ...
                        <div class="btn-group">
                            <x-button color="secondary" icon="plus" btnicon circle toggle="dropdown" haspopup="true" expanded="false" display="static" :items="[
                                        ['label' => 'Action', 'href' => 'javascript:void(0);'],
                                        ['label' => 'Another action', 'href' => 'javascript:void(0);'],
                                        ['label' => 'Something else here', 'href' => 'javascript:void(0);'],
                                        'divider',
                        ...
                        <div class="btn-group dropright">
                            <x-button color="info" icon="plus" btnicon circle toggle="dropdown" haspopup="true" expanded="false" display="static" :items="[
                                        ['label' => 'Action', 'href' => 'javascript:void(0);'],
                                        ['label' => 'Another action', 'href' => 'javascript:void(0);'],
                                        ['label' => 'Something else here', 'href' => 'javascript:void(0);'],
                                        'divider',
...
&lt;/a&gt;
                                ...
                                <x-button href="#" icon="sign-out-alt" id="ya-atau-tidak" data-title="Konfirmasi" data-message="Apakah Anda yakin ingin logout?" data-redirect-url="/" title="Logout" :label="__('Logout')" />
                            </x-slot>
                            <x-slot name='column2'>
...
&lt;/a&gt;
                                ...
                                <x-button href="#" icon="save" color="info" id="eksekusi" data-title="Informasi !!" data-message="Data sukses di simpan" data-redirect-url="/dashboard" title="Simpan" :label="__('Simpan')" />
                            </x-slot>
                        </x-row-column>
                    ...
                    <div class="tab-pane fade" id="tab10" role="tabpanel">
                        <x-row-column :column="4">
                            <x-slot name='column1'>
                                ...
                                <hr>
                                <x-button color="success" size="sm" :label="__('Success')" onclick="showToast('Success','Data sukses di simpan', 'success')" />
                            </x-slot>
                            <x-slot name='column2'>
                                <code>
                                ...
                                <hr>
                                <x-button color="info" size="sm" :label="__('Info')" onclick="showToast('Info','Data telah di hapus', 'info')" />
                            </x-slot>
                            <x-slot name='column3'>
                                <code>
                                ...
                                <hr>
                                <x-button color="danger" size="sm" :label="__('Error')" onclick="showToast('Error','Ada Masalah', 'error')" />
                            </x-slot>
                            <x-slot name='column4'>
                                <code>
                                ...
                                <hr>
                                <x-button color="warning" size="sm" :label="__('Warning')" onclick="showToast('Warning','Mohon di perhatikan', 'warning')" />
                            </x-slot>
                        </x-row-column>
                    </div>
                </x-tabs-pills>
