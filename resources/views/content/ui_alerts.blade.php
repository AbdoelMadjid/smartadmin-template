                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="demo-v-spacing">
                                <x-alert-messages color="primary">
                                    <strong>Heads up!</strong> This alert needs your attention, but it's not super
                                    important.
                                </x-alert-messages>
                                <x-alert-messages color="success">
                                    <strong>Well Done!</strong> You successfully read this important alert message.
                                </x-alert-messages>
                                <x-alert-messages color="danger">
                                    <strong>Oh snap!</strong> Change a few things up and try submitting again.
                                </x-alert-messages>
                                <x-alert-messages color="warning">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="demo-v-spacing">
                                ...
                                <x-alert-messages dismissible closeIcon="times-circle" color="info">
                                    <strong>Info!</strong> Alert for passing information to user.
                                </x-alert-messages>
                                <x-alert-messages dismissible closeIcon="window-close" color="secondary">
                                    <strong>Hello World!</strong> This is default alert message box.
                                </x-alert-messages>
                            </div>
                        </div>
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            <div class="demo-v-spacing">
                                ...
                                <x-alert-messages dismissible bground closeIcon="times" color="success">
                                    <div class="alert-icon width-1">
                                ...
                                <x-alert-messages class="bg-transparent text-info" bground color="info">
                                ...
                                <x-alert-messages class="bg-transparent text-info" bground color="danger">
                                    <div class="alert-icon">
                                ...
                                <x-alert-messages class="border-faded bg-transparent text-secondary" bground>
                                    <div class="alert-icon">
                                        <span class="icon-stack icon-stack-md">
                                ...
                                <x-alert-messages class="text-white" bground color="info" icon="info-circle"
                                    title="This branch is out-of-date with the base branch"
                                    deskripsi="Some pipes failed during build.">
                                ...
                                <x-alert-messages dismissible bground closeIcon="times" color="warning">
                                    <div class="alert-icon">
